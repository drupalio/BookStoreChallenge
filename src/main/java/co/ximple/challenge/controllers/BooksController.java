...
public record BooksController (){
    ...
    @GetMapping("/{id_book}")
    List<BookRecord> searchBooks(@PathVariable("id_book") String id_book){ return null;}
    ...
    @PostMapping("/loan")
    LoanRecord requestLoan(@RequestBody LoanRecord loan){ return null;}
    ...
    @PostMapping("/reviews")
    RatingRecord sendReview(@RequestBody RatingRecord review){ return null;}
    ...
    List<RatingRecord> listReviews(@PathVariable("id_book") String id_book){ return null;}
    ...
    @ApiResponse(responseCode = "200", description = "Book rated successfully",
            content = @Content(mediaType = "application/json",
                    schema = @Schema(implementation = RatingRecord.class)))
    @PostMapping("/ratings")
    RatingRecord rateBook(@RequestBody RatingRecord rating){ return null;}
}
